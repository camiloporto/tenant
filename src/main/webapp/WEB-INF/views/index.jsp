...
<html>
  ...
  <body>
		...
		<div class="span11" id="header-main">
			...
			<div class="pull-right">
				<form action="./usuarios/login" id="loginForm" class="navbar-form form-inline" method="POST">
					<input type="email" id="email" placeholder="Email" class="input-medium">
					<input type="password" id="password" placeholder="Password" class="input-medium">
    ...
    <div class="conainer" style="margin : 0 auto; max-width : 970px;">	
		<div id="content" class="row" style="margin : 60px 0;">
			<div class="span4" style="padding : 10px 0;">
				<ul>
					<li style="margin : 1.5em 0;">Proin sed nibh ut tortor vulputate rhoncus.</li>
					<li style="margin : 1.5em 0;">Aliquam pharetra felis in tellus varius mattis.</li>
					<li style="margin : 1.5em 0;">Integer posuere nisl at tellus iaculis.</li>
					<li style="margin : 1.5em 0;">Morbi dignissim interdum orci, eu pharetra.</li>
